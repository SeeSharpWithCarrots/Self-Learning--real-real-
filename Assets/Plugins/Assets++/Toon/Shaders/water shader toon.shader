...
////// Emissive:
                ...
                half4 _Ripple_var = tex2D(_Ripple,TRANSFORM_TEX(i.uv0, _Ripple));
                float4 _Base_var = tex2D(_Base,TRANSFORM_TEX(i.uv0, _Base));
                half3 MainTex = ((_Ripplecolor.rgb*_Ripple_var.rgb)+(_Base_var.rgb*_basecolor.rgb));
