...
Shader "JP Toon" {
    Properties {
        ...
        [MaterialToggle] _NDetail ("NDetail", Float ) = 0
    }
    SubShader {
        Tags {
            "RenderType"="Opaque"
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : COLOR {
                ...
                float4 _NormalDetail_var = tex2D(_NormalDetail,TRANSFORM_TEX(i.uv0, _NormalDetail));
                float3 NormalTex = (_ToonBump_var.rgb+lerp( 0.0, _NormalDetail_var.rgb, _NDetail ));
